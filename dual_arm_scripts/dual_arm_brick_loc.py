...
def calculate_brick_locations():
	...
	overhead_orientation_r = np.array([0.0249590815779,0.99649402929,0.00737916180073,-0.00486450832011])
	...
	robot_offset = [0.6, 0, 0, 0] #0.15-0.24
	bricks_per_layer = 6
	num_layers = 3
