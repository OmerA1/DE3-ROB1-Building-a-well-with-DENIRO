...
def main():
    ...
    #mat = quaternion_matrix(-0.0249590815779,0.999649402929,0.00737916180073,0.00486450832011)
    ...
    spwan_loc = Pose(
        ...
        position=Point(x=0.75, y=0.6, z=0.18),#y=0.227,z=0.169
...
def not_used():
    ...
    right_starting_joint= {'right_w0': 0.6699952259595108,
                             ...
                             'right_s0': 2-0.08000397926829805+0.5,
